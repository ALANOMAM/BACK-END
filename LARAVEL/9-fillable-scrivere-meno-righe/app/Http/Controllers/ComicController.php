...
class ComicController extends Controller
{
...

    {
        ...
        // abbiamo usato "update" invece di "fill" come prima giusto per sicurezza
        //se usavamo fill non si creavano problemi nel nostro caso, ma se esiste update c'è un motivo.
